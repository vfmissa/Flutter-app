...
class Comparativo extends StatefulWidget {
  ...
  Comparativo(this.amostra, this.julgador);
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Padding(
                          ...
                          child: Form(
                            key: _valueamostra,
                            child: TextFormField(style: TextStyle(fontSize: 30),
                              ...
                              validator: (value) {
                                if (value!.trim().isEmpty|| int.parse(value)<100) {
