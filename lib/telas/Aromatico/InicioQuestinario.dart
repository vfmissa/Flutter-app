              ...
              child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text("Insira o nome do Provador",
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        ElevatedButton(
                          ...
                          child: Text("Iniciar Teste", style: TextStyle(
                              color: Colors.black)),
                        ),
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        actions: <Widget>[
          TextFormField(keyboardType:TextInputType.number,controller:passwordcontroller,),
            ...
            onPressed: () {
              if(passwordcontroller.text=="123"){
                Navigator.pushAndRemoveUntil(
                  context,MaterialPageRoute(builder: (context) => GridMain()),
